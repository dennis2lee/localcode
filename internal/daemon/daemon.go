...
func (d *Daemon) routes(webFS fs.FS) {
	...
	d.mux.HandleFunc("GET /api/sessions/groups", d.handleGetGroups)
	d.mux.HandleFunc("POST /api/sessions/groups", d.handleSetGroups)
	d.mux.HandleFunc("POST /api/sessions/{id}/group", d.handleSetSessionGroup)
	...
	d.mux.HandleFunc("POST /api/sessions/{id}/archive", d.handleArchiveSession)
	d.mux.HandleFunc("POST /api/sessions/{id}/retrieve", d.handleRetrieveSession)
