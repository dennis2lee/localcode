...
export const setFoldThinking = (enabled) => api('POST', '/api/settings/fold-thinking', { enabled });
...
export const bookSchedule = (sessionID, when, prompt, repeat = {}) =>
  api('POST', `/api/sessions/${sessionID}/schedules`, { when, prompt, ...repeat });
