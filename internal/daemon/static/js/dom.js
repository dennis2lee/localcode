...
export const scheduleBtn = document.getElementById('schedule-btn');
export const scheduleModal = document.getElementById('schedule-modal');
export const scheduleWhenInput = document.getElementById('schedule-when');
export const scheduleWhenNote = document.getElementById('schedule-when-note');
export const schedulePromptInput = document.getElementById('schedule-prompt');
export const scheduleNote = document.getElementById('schedule-note');
export const scheduleSaveBtn = document.getElementById('schedule-save');
export const scheduleCancelBtn = document.getElementById('schedule-cancel');
export const scheduleRepeatBox = document.getElementById('schedule-repeat');
export const scheduleRepeatNote = document.getElementById('schedule-repeat-note');
export const scheduleTimesInput = document.getElementById('schedule-times');
export const scheduleUntilInput = document.getElementById('schedule-until');
export const scheduleKeepInput = document.getElementById('schedule-keep');
export const scheduleDetailsModal = document.getElementById('schedule-details-modal');
export const scheduleDetailsWhen = document.getElementById('schedule-details-when');
export const scheduleDetailsStatus = document.getElementById('schedule-details-status');
export const scheduleDetailsError = document.getElementById('schedule-details-error');
export const scheduleDetailsRepeat = document.getElementById('schedule-details-repeat');
export const scheduleDetailsRule = document.getElementById('schedule-details-rule');
export const scheduleDetailsPrompt = document.getElementById('schedule-details-prompt');
export const scheduleDetailsAgent = document.getElementById('schedule-details-agent');
export const scheduleDetailsOpenBtn = document.getElementById('schedule-details-open');
export const scheduleDetailsCloseBtn = document.getElementById('schedule-details-close');
export const debateBtn = document.getElementById('debate-btn');
export const debateModal = document.getElementById('debate-modal');
export const debateReviewersEl = document.getElementById('debate-reviewers');
export const debateRoundsInput = document.getElementById('debate-rounds');
export const debateTaskInput = document.getElementById('debate-task');
export const debatePreviewEl = document.getElementById('debate-preview');
export const debateNoteEl = document.getElementById('debate-note');
export const debateStartBtn = document.getElementById('debate-start');
export const debateCancelBtn = document.getElementById('debate-cancel');
...
export const findOlderBtn = document.getElementById('find-older');
export const findNewerBtn = document.getElementById('find-newer');
export const findCloseBtn = document.getElementById('find-close');
...
export const mcpResetBtn = document.getElementById('mcp-reset-btn');
...
export const effortBtn = document.getElementById('effort-btn');
export const usageBtn = document.getElementById('usage-btn');
export const usageModalEl = document.getElementById('usage-modal');
export const usageScopeEl = document.getElementById('usage-scope');
export const usageRowsEl = document.getElementById('usage-rows');
export const usageNoteEl = document.getElementById('usage-note');
export const usageCloseBtn = document.getElementById('usage-close');
export const effortModal = document.getElementById('effort-modal');
export const effortModelEl = document.getElementById('effort-model');
export const effortLevelsEl = document.getElementById('effort-levels');
export const effortNoteEl = document.getElementById('effort-note');
export const effortDefaultBtn = document.getElementById('effort-default');
export const effortCloseBtn = document.getElementById('effort-close');
...
export const archiveSectionEl = document.getElementById('archive-section');
export const archiveToggleEl = document.getElementById('archive-toggle');
export const archiveListEl = document.getElementById('archive-list');
export const orchestrateCheckbox = document.getElementById('orchestrate-checkbox');
export const orchestrateNoteEl = document.getElementById('orchestrate-note');
export const orchestrateWarnEl = document.getElementById('orchestrate-warn');
export const modelInvocableCheckbox = document.getElementById('model-invocable-checkbox');
export const modelInvocableNoteEl = document.getElementById('model-invocable-note');
export const modelInvocableWarnEl = document.getElementById('model-invocable-warn');
